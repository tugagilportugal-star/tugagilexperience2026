...
export const About: React.FC = () => {
  return (
    <section id="about" className="relative min-h-[90vh] flex flex-col justify-center bg-zinc-950 text-white pb-24 overflow-hidden border-t border-zinc-900">
      ...
      {/* 1. ESTILOS DA ANIMAÇÃO (Injetados de forma 100% segura para o TypeScript) [1.2.7] */}
      ...
      {/* 2. FAIXA VERDE ROTACIONADA (Slanted Marquee) */}
      ...
      {/* 3. IMAGEM DE FUNDO (Gaia) - Com brilho e visualização completa */}
      <div className="absolute inset-0 z-0 mt-20">
        ...
        />
        {/* Filtro de escurecimento suave */}
        <div className="absolute inset-0 bg-zinc-950/85 backdrop-blur-[2px]" />
      </div>

      {/* 4. CONTEÚDO EDITORIAL À ESQUERDA (História conectada ao Evento) [0.2] */}
